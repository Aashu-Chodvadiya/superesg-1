        ...
        <div className='featured-section'>
            <div className='container'>
                ...
                <div className='featured-grid'>
                    <div>
                        <div className='featured-item animate__animated  animate__fadeInLeft wow'  data-wow-offset='100'>
                    ...
                    <div>
                        <div className='featured-item animate__animated  animate__fadeInRight wow'  data-wow-offset='100'>
                            <div className='featured-image'>
