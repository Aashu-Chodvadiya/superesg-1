        ...
        <div className='hairstyle-section'>
            <div className='container'>
                <div className='hairstyle-grid'>
                    <div className='hairstyle-item animate__animated animate__slideInLeft wow'  data-wow-offset='100'>
                    ...
                    <div className='hairstyle-item animate__animated animate__slideInRight wow'  data-wow-offset='100'>
