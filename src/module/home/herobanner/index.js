    ...
    <div className='herobanner-section'>
      <div className='container'>
        <div className='herobanner-main'>
          <div className='herobanner-text animate__animated animate__fadeIn wow'  data-wow-offset='100'>
            <h1>
            ...
            <div className='search-bar-grid'>
              ...
              <div className='search-bar-item-2'>
                <div className='search-flex'>
                  ...
                  <div className='search-btn animate__animated animate__zoomIn wow'  data-wow-offset='100'>
