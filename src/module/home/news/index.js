        ...
        <div className='news-section'>
            <div className='container'>
                {/* <div className='news-flex'> */}
                    <div className='news-heading animate__animated animate__zoomIn wow'  data-wow-offset='100'>
                ...
                <div className='news-grid'>
                    <div className='news-item animate__animated animate__slideInLeft wow'  data-wow-offset='100'>
                    ...
                    <div className='news-item animate__animated animate__zoomIn wow'  data-wow-offset='100'>
                        <div className='news-image'>
                    ...
                    <div className='news-item animate__animated animate__slideInRight wow'  data-wow-offset='100'>
                        <div className='news-image'>
