  ...
  return (
    <div className='strategy-section'>
        <div className='container'>
            <div className='strategy-heading animate__animated animate__fadeIn wow'  data-wow-offset='100'>
            ...
            <div className='strategy-grid'>
                <div className='strategy-item  animate__animated  animate__fadeInRight wow'  data-wow-offset='100'>
                ...
                <div className='strategy-item  animate__animated  animate__fadeInLeft wow'  data-wow-offset='100'>
                    <div className='strategy-color'></div>
                    <h4>Analyse</h4>
