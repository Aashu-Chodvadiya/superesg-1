    ...
    return (
        <div className='footer-section'>
            <div className='footer-main'>
                <div className='container'>
                    <div className='footer-grid'>
                        <div className='footer-item-1 animate__animated animate__slideInDown wow'  data-wow-offset='100'>
                        ...
                        <div className='footer-item-2'>
                            <div className='footer-menu-flex'>
                                <div className='footer-menu-item animate__animated animate__slideInRight wow'  data-wow-offset='100'>
                                    <h5>Product</h5>
                                    <a>Shared Inbox</a>
                                    <a>Knowledge Base</a>
                                    <a>Live Chat</a>
                                ...
                                <div className='footer-menu-item animate__animated animate__slideInLeft wow'  data-wow-offset='100'>
                                    <h5>Consultants</h5>
                                    <a>Shared Inbox</a>
                                    <a>Knowledge Base</a>
                                    <a>Live Chat</a>
            ...
            <div className='footer-last-line'>
                <div className='container'>
                    <div className='footer-last-line-flex animate__animated animate__slideInUp wow'  data-wow-offset='10'>
                        <a>© 2022 Superesg</a>
                        <a>Privacy Policy</a>
